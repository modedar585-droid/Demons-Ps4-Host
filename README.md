...
<head>
    ...
    <title>Demons PS4 Host - v9.00 Elite</title>
    
    <script src="https://cdnjs.cloudflare.com/ajax/libs/gsap/3.12.2/gsap.min.js"></script>

    <script src="common/relocator.js"></script>
    <script src="common/syscalls.js"></script>
    <script src="common/syscalls2.js"></script>
    
    <script src="int64.js"></script>
    <script src="rop.js"></script>
    <script src="webkit.js"></script> <script src="kexploit.js"></script>
    
    <script src="kexploit-launcher.js"></script>
    <script src="fakeusb.js"></script>
...
<body>
    ...
    <div class="main-container">
        <div class="header">
            <h1>DEMONS ELITE</h1>
            <div class="status-bar" id="statusText">جاهز للاختراق.. بانتظار أمرك</div>
        </div>
        <div class="loader" id="mainLoader"></div>
        <div class="grid-menu">
            <div class="btn-card" onclick="startJailbreak()">
                <div style="font-size: 45px; margin-bottom: 15px;">💎</div>
                <span>تشغيل GoldHEN</span>
            </div>
    ...
    <script>
        ...
        function startJailbreak() {
            ...
            status.innerText = "جاري تنفيذ الثغرة.. انتظر رسالة USB";
            status.style.color = "var(--neon-blue)";
            
            setTimeout(() => {
                try {
                    // نداء لدالة التشغيل الأصلية
                    run_exploit(); 
                } catch(e) {
                    // في حالة طلب الفلاشة أو حدوث خطأ متوقع
                    status.innerText = "⚠️ قم بإدخال الفلاشة الآن";
